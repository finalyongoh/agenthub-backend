	...
	SecurityFilterChain securityFilterChain(
		...
		http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(HttpMethod.GET, "/api/repositories", "/api/repositories/*", "/api/repositories/*/analysis").permitAll()
				.requestMatchers(HttpMethod.POST, "/api/repositories/*/analysis").permitAll()
